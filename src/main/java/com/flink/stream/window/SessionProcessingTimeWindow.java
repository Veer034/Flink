...
public class SessionProcessingTimeWindow {
    public static void main(String[] args) throws Exception
    {
        ...
        String output ="file:///Users/ranvsing/CodeBase/Flink/output/window/sessionprocess";

        // file contains AgeGroup, Salary, Count
        DataStream<Tuple3< String, Integer, Integer>> mapped = data.map(new Tokenizer());      // tuple  [June,Category5,Bat,12,1]

        // groupBy 'ageGroup' with Session window
        ...
        // execute program
        environment.execute("Session Process Group Salary");
    }
    /**
