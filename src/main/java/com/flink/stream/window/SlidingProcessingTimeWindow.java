...
public class SlidingProcessingTimeWindow {
    public static void main(String[] args) throws Exception
    {
        ...
        String output ="file:///Users/ranvsing/CodeBase/Flink/output/window/slideprocess";

        // file contains AgeGroup, Salary, Count
        DataStream<Tuple3<String, Integer, Integer>> mapped = data.map(new Tokenizer());

        // groupBy 'ageGroup' with Sliding window
        ...
        // execute program
        environment.execute("Sliding Process Group Salary");
    }
